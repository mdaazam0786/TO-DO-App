        ...
        Box(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
                OutlinedTextField(value = viewModel.title, onValueChange = {title->
                    viewModel.onAddEditEvent(AddScreenEvent.onTitleChange(title))
                },
                    placeholder = {
                ...
                OutlinedTextField(value = viewModel.description, onValueChange = {desc->
                    viewModel.onAddEditEvent(AddScreenEvent.onDescChange(desc))
                },
                    placeholder = {
                ...
                Button(
                    onClick = {
                         viewModel.onAddEditEvent(AddScreenEvent.onSaveTodo)
                    },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(120.dp)
